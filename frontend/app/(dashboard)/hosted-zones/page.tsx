...
export default function Zones() {
  ...
  return <div className="zone-list-page">
    <div className="zone-crumbbar"><button aria-label="Open navigation" onClick={() => window.dispatchEvent(new Event('toggle-sidebar'))}>☰</button><Link href="/hosted-zones">Route 53</Link><span>›</span><strong>Hosted zones</strong><span className="zone-crumb-spacer" /><span>ⓘ</span></div>
